 ...
 * @JsonProperty("CEO") private String cEO;
 * @JsonProperty("sector") private String sector;
 * @JsonProperty("financials") private List<Financial> financials = null;
 * @JsonProperty("dividends") private List<Dividend> dividends = null;
 ...
 * this.companyName = companyName;
 * }
 * @JsonProperty("exchange") public String getExchange() {
 * return exchange;
 * }
 * @JsonProperty("exchange") public void setExchange(String exchange) {
 * this.exchange = exchange;
 * }
 ...
 * this.description = description;
 * }
 * @JsonProperty("CEO") public String getCEO() {
 * return cEO;
 * }
 * @JsonProperty("CEO") public void setCEO(String cEO) {
 * this.cEO = cEO;
 * }
 * @JsonProperty("sector") public String getSector() {
 * return sector;
 * }
 * @JsonProperty("sector") public void setSector(String sector) {
 * this.sector = sector;
 * }
 * @JsonProperty("financials") public List<Financial> getFinancials() {
 * return financials;
 * }
 * @JsonProperty("financials") public void setFinancials(List<Financial> financials) {
 * this.financials = financials;
 * }
 * @JsonProperty("dividends") public List<Dividend> getDividends() {
 * return dividends;
 * }
 * @JsonProperty("dividends") public void setDividends(List<Dividend> dividends) {
 * this.dividends = dividends;
 * }
